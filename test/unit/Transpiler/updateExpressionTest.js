...
*/;}), // jshint ignore:line
    ...
    it('should correctly transpile a post-increment of a property', function () {
        var inputJS = nowdoc(function () {/*<<<EOS
a.b++;
EOS
*/;}), // jshint ignore:line
...
*/;}), // jshint ignore:line
    ...
    it('should correctly transpile a post-increment of a property of a property', function () {
        var inputJS = nowdoc(function () {/*<<<EOS
a.b.c++;
EOS
*/;}), // jshint ignore:line
...
*/;}), // jshint ignore:line
    ...
    it('should correctly transpile a post-increment of a computed property of a property', function () {
        var inputJS = nowdoc(function () {/*<<<EOS
a.b[c + 21]++;
EOS
*/;}), // jshint ignore:line
